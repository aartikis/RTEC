...
[ ! -z $input_mode ] && [ "$input_mode" != "csv" ] && [ "$input_mode" != "fifo" ] && [ "$input_mode" != "socket" ] && echo "provided" && exit_func "wrongInputMode" $input_mode # the provided input mode is not csv or fifo
