...
initiatedAt(person(_3162)=true, _3206, _3134, _3212) :-
     happensAtProcessedIE(_3162,startI(walking(_3162)=true),_3134),_3206=<_3134,_3134<_3212,
     \+happensAtIE(disappear(_3162),_3134).

initiatedAt(person(_3162)=true, _3206, _3134, _3212) :-
     happensAtProcessedIE(_3162,startI(running(_3162)=true),_3134),_3206=<_3134,_3134<_3212,
     \+happensAtIE(disappear(_3162),_3134).

initiatedAt(person(_3162)=true, _3206, _3134, _3212) :-
     happensAtProcessedIE(_3162,startI(active(_3162)=true),_3134),_3206=<_3134,_3134<_3212,
     \+happensAtIE(disappear(_3162),_3134).

initiatedAt(person(_3162)=true, _3206, _3134, _3212) :-
     happensAtProcessedIE(_3162,startI(abrupt(_3162)=true),_3134),_3206=<_3134,_3134<_3212,
     \+happensAtIE(disappear(_3162),_3134).
...
initiatedAt(meeting(_3162,_3164)=true, _3230, _3134, _3236) :-
     happensAtProcessedSDFluent(_3162,startI(greeting1(_3162,_3164)=true),_3134),_3230=<_3134,_3134<_3236,
     \+happensAtIE(disappear(_3162),_3134),
     \+happensAtIE(disappear(_3164),_3134).

initiatedAt(meeting(_3162,_3164)=true, _3230, _3134, _3236) :-
     happensAtProcessedSDFluent(_3162,startI(greeting2(_3162,_3164)=true),_3134),_3230=<_3134,_3134<_3236,
     \+happensAtIE(disappear(_3162),_3134),
     \+happensAtIE(disappear(_3164),_3134).

initiatedAt(meeting(_3162,_3164)=false, _3188, _3134, _3194) :-
     happensAtProcessedIE(_3162,startI(running(_3162)=true),_3134),
     _3188=<_3134,
     _3134<_3194.

initiatedAt(meeting(_3162,_3164)=false, _3188, _3134, _3194) :-
     happensAtProcessedIE(_3164,startI(running(_3164)=true),_3134),
     _3188=<_3134,
     _3134<_3194.

initiatedAt(meeting(_3162,_3164)=false, _3188, _3134, _3194) :-
     happensAtProcessedIE(_3162,startI(abrupt(_3162)=true),_3134),
     _3188=<_3134,
     _3134<_3194.

initiatedAt(meeting(_3162,_3164)=false, _3188, _3134, _3194) :-
     happensAtProcessedIE(_3164,startI(abrupt(_3164)=true),_3134),
     _3188=<_3134,
     _3134<_3194.

initiatedAt(meeting(_3162,_3164)=false, _3192, _3134, _3198) :-
     happensAtProcessedSDFluent(_3162,startI(close(_3162,_3164,34)=false),_3134),
     _3192=<_3134,
     _3134<_3198.
