...
initiatedAt(rich(_3162)=true, _3176, _3134, _3182) :-
     happensAtIE(win_lottery(_3162),_3134),
     _3176=<_3134,
     _3134<_3182.
...
maxDurationUE(rich(_3360)=true,rich(_3360)=false,4) :- 
     grounding(rich(_3360)=true).
