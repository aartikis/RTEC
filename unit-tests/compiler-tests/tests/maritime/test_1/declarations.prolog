...
/********************************************************************** DECLARATIONS *******************************************************************************
 ...
 -All values V of a simple fluent F must be explicitly declared.
 -For each input/output entity state its index. A fluent F must have the same index in all fluent-value pairs F=V.
