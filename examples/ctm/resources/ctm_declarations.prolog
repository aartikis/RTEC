...
simpleFluent(passenger_density(_,_)=low).		outputEntity(passenger_density(_,_)=low).		index(passenger_density(Id,_)=low, 		Id).
simpleFluent(noise_level(_,_)=high).			outputEntity(noise_level(_,_)=high).			index(noise_level(Id,_)=high, 			Id).
simpleFluent(noise_level(_,_)=low).			outputEntity(noise_level(_,_)=low).			index(noise_level(Id,_)=low, 			Id).
...
simpleFluent(internal_temperature(_,_)=warm).		outputEntity(internal_temperature(_,_)=warm).		index(internal_temperature(Id,_)=warm, 		Id).
simpleFluent(internal_temperature(_,_)=normal).		outputEntity(internal_temperature(_,_)=normal).		index(internal_temperature(Id,_)=normal, 	Id).
simpleFluent(internal_temperature(_,_)=cold).		outputEntity(internal_temperature(_,_)=cold).		index(internal_temperature(Id,_)=cold,	 	Id).
...
% No points/1 declarations are necessary in CTM
